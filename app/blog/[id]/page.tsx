...
export default async function Post({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
      <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <Link href="/blog" className="inline-block bg-primary text-primary-foreground px-6 py-3 rounded-lg hover:bg-primary/90 transition-colors">
            Back to Blog
          </Link>
        </div>
        <Footer />
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Hero Section */}
      <section className="relative py-12 sm:py-16 md:py-24 lg:py-32 bg-secondary/50 text-foreground">
        <div className="absolute inset-0 z-0 opacity-10">
          <div className="absolute inset-0 bg-[url('/grid.svg')] bg-center [mask-image:linear-gradient(180deg,var(--background),rgba(255,255,255,0))]"></div>
        </div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-6 sm:mb-8">
              <Link
                href="/blog"
                className="inline-flex items-center gap-2 text-sm sm:text-base text-muted-foreground hover:text-foreground transition-colors group"
              >
            ...
            <div className="text-center mb-6 sm:mb-8">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 sm:mb-8 leading-tight gradient-text px-2">
                {postData.title}
              </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
              {/* Main Content */}
              <div className="flex-1 min-w-0 xl:max-w-6xl xl:ml-72">
                <div className="bg-card rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden border border-border">
                  ...
                  <div className="p-4 sm:p-6 md:p-8 lg:p-12">
                    ...
                    <article className="prose prose-lg sm:prose-xl max-w-none
                      prose-headings:text-foreground prose-headings:font-bold prose-headings:mt-8 prose-headings:mb-4 sm:prose-headings:mt-12 sm:prose-headings:mb-6
                      prose-h1:text-2xl sm:prose-h1:text-3xl md:prose-h1:text-4xl prose-h1:mb-6 sm:prose-h1:mb-8 prose-h1:mt-0
                      prose-h2:text-xl sm:prose-h2:text-2xl md:prose-h2:text-3xl prose-h2:border-b prose-h2:border-border prose-h2:pb-2 sm:prose-h2:pb-3 prose-h2:mb-4 sm:prose-h2:mb-8
                      prose-p:text-muted-foreground prose-p:leading-relaxed prose-p:text-base sm:prose-p:text-lg
                      prose-pre:bg-muted prose-pre:text-foreground prose-pre:rounded-lg prose-pre:shadow-lg prose-pre:overflow-x-auto
                      prose-code:text-primary prose-code:bg-muted prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:text-xs sm:prose-code:text-sm prose-code:font-mono
                      max-sm:prose-pre:text-xs max-sm:prose-code:text-xs max-sm:prose-pre:p-3 sm:prose-pre:p-4 md:prose-pre:p-6
                      prose-blockquote:border-l-4 prose-blockquote:border-primary prose-blockquote:bg-primary/5 prose-blockquote:pl-4 prose-blockquote:py-2 prose-blockquote:my-4 prose-blockquote:rounded-r-lg
                      prose-ul:list-disc prose-ul:space-y-2 prose-ul:text-muted-foreground
                      prose-ol:list-decimal prose-ol:space-y-2 prose-ol:text-muted-foreground
                      prose-li:leading-relaxed prose-li:text-base sm:prose-li:text-lg
                      prose-strong:text-foreground prose-strong:font-semibold
                      prose-em:text-muted-foreground prose-em:italic
                      prose-a:text-primary prose-a:no-underline prose-a:hover:text-primary/80 prose-a:hover:underline prose-a:font-medium
                      ...
                      prose-td:px-4 prose-td:py-3 prose-td:border-b prose-td:border-border prose-td:text-muted-foreground
                    ...
                    <div className="mt-16 pt-8 border-t border-border">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                        <Link href="/blog" className="text-primary hover:text-primary/80 font-semibold inline-flex items-center group">
            ...
            {/* Author Bio Card */}
            <div className="mt-12 bg-gradient-to-br from-primary/5 to-secondary/50 rounded-2xl p-8 border border-border xl:ml-72 xl:max-w-6xl">
      ...
      {/* CTA Section */}
      <AnimatedSection animationType="fadeIn" className="py-16 md:py-24 bg-secondary/50 text-foreground">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/contact"
              className="px-8 py-4 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-semibold rounded-lg hover:from-primary/90 hover:to-primary/70 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Get In Touch
            </Link>
            <Link
              href="/projects"
              className="px-8 py-4 border-2 border-border text-foreground font-semibold rounded-lg hover:border-primary hover:bg-primary/10 transition-all duration-300 transform hover:scale-105"
            >
              View My Work
            </Link>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-border">
            <p className="text-muted-foreground mb-4">Read more articles like this</p>
            <Link
              href="/blog"
